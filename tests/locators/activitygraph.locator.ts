...
async function getActivitygraphNoData(page: Page) {
  const activitygraphNoData = page.locator("//p[text()='No data to display']")
  await expect(activitygraphNoData).toBeVisible({ timeout: 5000 })
  return activitygraphNoData
}
